...
INSERT INTO "new_SaleTransaction" ("id", "userId", "paymentMethod", "status", "customerName", "subtotal", "tax", "total", "createdAt", "updatedAt") SELECT "id", "userId", "paymentMethod", "status", "customerName", "subtotal", "tax", "total", "createdAt", "updatedAt" FROM "SaleTransaction";
