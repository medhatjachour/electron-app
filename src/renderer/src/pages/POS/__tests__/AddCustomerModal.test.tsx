...
describe('AddCustomerModal', () => {
  ...
  describe('Rendering', () => {
    it('should render modal when show is true', () => {
      ...
      expect(screen.getByLabelText('customerNameRequired')).toBeInTheDocument()
      expect(screen.getByLabelText('emailAddress')).toBeInTheDocument()
      expect(screen.getByLabelText('phoneNumberRequired')).toBeInTheDocument()
      expect(screen.getByLabelText('loyaltyTier')).toBeInTheDocument()
    })

    it('should not render modal when show is false', () => {
      render(<AddCustomerModal {...defaultProps} show={false} />)
  ...
  describe('Form Validation', () => {
    it('should show error for empty name', async () => {
      ...
      expect(mockToast.error).toHaveBeenCalledWith('nameIsRequired')
    ...
    it('should show error for invalid email format', async () => {
      ...
      expect(mockToast.error).toHaveBeenCalledWith('pleaseEnterValidEmail')
      expect(mockIpc.customers.create).not.toHaveBeenCalled()
    })
    ...
    it('should show error for empty phone', async () => {
      ...
      expect(mockToast.error).toHaveBeenCalledWith('phoneNumberIsRequired')
      expect(mockIpc.customers.create).not.toHaveBeenCalled()
    })
  ...
  describe('Form Submission', () => {
    ...
    it('should submit form successfully', async () => {
      ...
      await waitFor(() => {
        ...
        expect(mockToast.success).toHaveBeenCalledWith('customerAddedSuccessfully')
    ...
    it('should handle duplicate customer error', async () => {
      ...
      await waitFor(() => {
        expect(mockToast.error).toHaveBeenCalledWith('Customer already exists')
        expect(mockToast.info).toHaveBeenCalledWith('existingCustomer: Existing Customer')
