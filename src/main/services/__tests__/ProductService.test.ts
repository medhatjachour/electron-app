...
describe('ProductService', () => {
  ...
  describe('queryProducts', () => {
    ...
    it('should query products with filters', async () => {
      ...
      mockProductRepository.findPaginated.mockResolvedValue(mockResult)

      const result = await productService.queryProducts(queryDTO)

      expect(mockProductRepository.findPaginated).toHaveBeenCalled()
    ...
    it('should handle empty results', async () => {
      ...
      mockProductRepository.findPaginated.mockResolvedValue(emptyResult)
